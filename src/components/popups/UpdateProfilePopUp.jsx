                ...
                <Box m={2}>
                  <FormControl className="custom-input-box">
                    ...
                    >
                      ...
                      <MenuItem value="/images/Avatar1.png">Person 1</MenuItem>
                      <MenuItem value="/images/Avatar5.png">Person 2</MenuItem>
                      <MenuItem value="/images/Avatar6.png">Person 3</MenuItem>
                      <MenuItem value="/images/Avatar2.png">Person 4</MenuItem>
                      <MenuItem value="/images/Avatar4.png">Person 5</MenuItem>
                      <MenuItem value="/images/Avatar3.png">Person 6</MenuItem>
                    </Select>
                  </FormControl>
                </Box>
                <Box m={2}>

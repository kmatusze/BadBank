                  ...
                  <Box m={2}>
                    <FormControl className="custom-input-box">
                      ...
                      >
                        ...
                        <MenuItem value="/images/Avatar2.png">Person 1</MenuItem>
                        <MenuItem value="/images/Avatar4.png">Person 2</MenuItem>
                        <MenuItem value="/images/Avatar3.png">Person 3</MenuItem>
                      </Select>
                    </FormControl>
                  </Box>
                  <Box m={2}>
